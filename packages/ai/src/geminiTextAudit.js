...
exports.auditPageText = auditPageText;
const geminiClient_1 = require("./geminiClient");
async function auditPageText(pageText, pageUrl) {
...
"""`;
    try {
        const response = await geminiClient_1.geminiFlash.generateContent(prompt);
...
//# sourceMappingURL=geminiTextAudit.js.map