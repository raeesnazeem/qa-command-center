...
import { X, Send, CheckCircle2, ImageIcon, MessageSquare, Loader2, FileText } from "lucide-react"
        ...
        <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-sm uppercase tracking-widest">
                  {issueNumber ? `Issue #${issueNumber}` : "Task"} - Mark as Resolved
                </h3>
          ...
          <div className="p-8 overflow-y-auto space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-xs text-slate-600 italic leading-relaxed max-h-24 overflow-y-auto">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none min-h-[120px] transition-all"
              />
            </div>
            ...
            <div className="space-y-3">
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center">
                <ImageIcon className="w-3 h-3 mr-1" /> Confirmation Screenshot (Optional)
              </span>
              
              <div 
                onClick={() => fileInputRef.current?.click()}
                className={`relative group cursor-pointer border-2 border-dashed rounded-2xl p-8 transition-all flex flex-col items-center justify-center gap-2 ${
                  screenshotUrl 
              ...
              >
                ...
                {isUploading ? (
                  ...
                  <div className="relative w-full aspect-video rounded-lg overflow-hidden border border-emerald-200 shadow-sm">
                    <img src={screenshotUrl} className="w-full h-full object-cover" alt="Preview" />
                  ...
                  <>
                    ...
                    <div className="text-center">
                      <p className="text-xs font-bold text-slate-600 uppercase tracking-tight">Click to upload screenshot</p>
          ...
          <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
            ...
            <button
              ...
              className="btn-unified bg-emerald-600 hover:bg-emerald-700 flex items-center gap-2 disabled:opacity-50"
            >
              {isPending ? (
