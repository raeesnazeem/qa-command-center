...
export const HeroMediaFindingCard: React.FC<FindingCardProps> = ({
  ...
  const isProjectPlan = false
  const isPaidMedia = false
  const isHeroMedia = true // Hardcoded for this specific card
  const isPrivacyPolicy = false
  const isFullWidth = true // FULL_WIDTH_FACTORS.includes("hero_media")
