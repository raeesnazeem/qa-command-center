...
const DeveloperLeaderboard: React.FC<DeveloperLeaderboardProps> = ({
  data,
}) => {
  return (
            ...
            {data.map((item) => (
              <tr
                ...
                className={`hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors ${
                  item.rank === 1 ? "bg-slate-50/50 dark:bg-slate-800/50" : ""
                }`}
              >
                ...
                <td className="px-4 py-3 text-center">
                  <span
                    className={`text-xs font-medium ${
                      item.rebuttals > 5 ? "text-red-500 dark:text-red-400" : "text-slate-600 dark:text-slate-400"
                    }`}
                  >
                    {item.rebuttals}
                  </span>
