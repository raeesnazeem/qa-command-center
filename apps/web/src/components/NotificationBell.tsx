          ...
          <div className="max-h-96 overflow-y-auto divide-y divide-slate-50">
            {notifications.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="text-sm text-slate-700 leading-tight">
                      <span className="font-bold text-slate-900">{notif.activity?.performer_name}</span>{' '}
                      {notif.activity?.details?.message || notif.activity?.action_type.replace(/_/g, ' ').toLowerCase()}
                    </p>
              ...
              <div className="py-12 flex flex-col items-center justify-center text-center px-6">
                ...
                <p className="text-sm font-bold text-slate-900">Your inbox is empty</p>
                <p className="text-xs text-slate-400 mt-1">When you receive a notification, it will appear here.</p>
              </div>
            )}
          </div>
