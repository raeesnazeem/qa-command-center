      ...
      <div className="relative w-full max-w-lg bg-slate-50 dark:bg-[#131d22] border border-slate-200 dark:border-[#1d2a31] rounded-md shadow-sm overflow-hidden transition-all duration-200">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-slate-50 dark:bg-[#1d2a31] border ${
                    errors.name ? 'border-red-500/50 dark:border-red-500/50' : 'border-slate-200 dark:border-slate-700'
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-50 dark:bg-[#1d2a31] border ${
                    errors.site_url ? 'border-red-500/50 dark:border-red-500/50' : 'border-slate-200 dark:border-slate-700'
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1.5">
                Client Name <span className="text-slate-400 dark:text-slate-500 text-[10px] uppercase ml-1">(Optional)</span>
              </label>
              <div className="relative">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-[#1d2a31] rounded-md border border-slate-100 dark:border-slate-700/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-white">WooCommerce</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Enable e-commerce specific QA checks</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-900/20 rounded-md border border-amber-100 dark:border-amber-800/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-amber-900 dark:text-amber-50">Pre-release Project</h4>
                  <p className="text-xs text-amber-700 dark:text-amber-200/70">Prioritize this project on the QA dashboard</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
