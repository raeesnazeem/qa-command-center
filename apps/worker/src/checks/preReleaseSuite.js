    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            footer.scrollIntoViewIfNeeded().catch(function () {}),
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 18:
          ...
          return [
            4 /*yield*/,
            renderPage.setContent(
              '<pre style="font-size: 14px; white-space: pre-wrap; word-wrap: break-word; padding: 20px; background: #f4f4f4;">'.concat(
                codeSnippet.replace(/</g, "&lt;").replace(/>/g, "&gt;"),
                "</pre>",
              ),
            ),
          ]
        ...
        case 20:
          ...
          return [
            ...
            uploadScreenshot(
              codeBuffer,
              "".concat(runId, "/").concat(pageId, "/single_script_code.png"),
            ),
          ]
        case 21:
          codeUrl = _a.sent()
      ...
      switch (_a.label) {
        ...
        case 8:
          ...
          return [
            ...
            uploadScreenshot(
              buffer,
              "".concat(runId, "/").concat(pageId, "/header_nav.png"),
            ),
          ]
        case 9:
          headerUrl = _a.sent()
        ...
        case 15:
          ...
          return [
            ...
            uploadScreenshot(
              codeBuffer,
              "".concat(runId, "/").concat(pageId, "/header_code.png"),
            ),
          ]
        case 16:
          codeUrl = _a.sent()
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            axios_1.default.head(faviconHref, { timeout: 10000 }),
          ]
        case 3:
          response = _a.sent()
          if (response.status !== 200) {
            findings.push({
              ...
              description:
                "A favicon link was found, but fetching the file returned an HTTP status of ".concat(
                  response.status,
                  ".",
                ),
              status: "open",
        ...
        case 4:
          ...
          findings.push({
            ...
            description: 'We found a favicon link at "'
              .concat(
                faviconHref,
                '", but we encountered an error while trying to fetch it: ',
              )
        ...
        case 1:
          ...
          if (
            ...
            findings.push({
              ...
              description: 'The page tab title "'.concat(
                pageTitle || "Empty",
                '" is invalid or blank. Please format it with your business name and page details.',
              ),
              status: "open",
              ai_generated: false,
            })
          ...
          if (liveSiteUrl) {
            try {
              ...
              isHomepage =
                ...
                currentUrl.replace(/www\./, "") ===
                  liveSiteUrl.replace(/www\./, "")
              if (isHomepage && devUrls.length > 0) {
                ...
                missingPaths = essentialPaths.filter(function (path) {
                  return !devPaths_1.some(function (devPath) {
                    return devPath.endsWith(path)
                  })
                })
                if (missingPaths.length > 0) {
                  findings.push({
                    ...
                    description:
                      "We compared standard live site page paths and found some essential paths are missing on the new dev site: ".concat(
                        missingPaths.join(", "),
                        ". Please verify if these should be migrated.",
                      ),
                    status: "open",
                    ai_generated: false,
                  })
              ...
              logger.error(
                { error: e.message },
                "Error during URL sitemap matching.",
              )
            }
          }
          return [2 /*return*/, findings]
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 5:
          ...
          _b.label = 6
        case 6:
          return [4 /*yield*/, emailInput.count()]
        case 7:
        ...
        case 8:
          ...
          _b.label = 9
        case 9:
          return [4 /*yield*/, phoneInput.count()]
        case 10:
        ...
        case 11:
          ...
          _b.label = 12
        case 12:
          return [4 /*yield*/, submitBtn.count()]
        case 13:
          _a = _b.sent() > 0
        ...
        case 16:
          ...
          findings.push({
            ...
            description:
              "We attempted to interact with the contact form on this page, but experienced an error: ".concat(
                e_4.message,
              ),
            status: "open",
            ai_generated: false,
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          findings = []
          chatbotLauncher = page.locator(
            "#g99-chatbot-launcher, .g99-chatbot-launcher, #g99-chatbot-button",
          )
          virtualConsultationLauncher = page.locator(
        ...
        case 1:
          ...
          return [
            ...
            page.evaluate(function () {
              ...
              var ogSiteName = document.querySelector(
          ...
          if (metaTags.ogTitle) {
            ...
            if (
              ...
              findings.push({
                ...
                description: 'The og:title is set to a default value "'.concat(
                  metaTags.ogTitle,
                  '", which looks like a WordPress boilerplate. Please update this tag before release.',
                ),
                status: "open",
                ai_generated: false,
              })
          ...
          if (metaTags.ogSiteName) {
            ...
            if (
              ...
              findings.push({
                ...
                description:
                  'The og:site_name contains default placeholder text "'.concat(
                    metaTags.ogSiteName,
                    '" instead of matching the actual business name.',
                  ),
                status: "open",
                ai_generated: false,
              })
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 11:
          ...
          return [
            4 /*yield*/,
            adminPage.waitForLoadState("domcontentloaded", { timeout: 15000 }),
        ...
        case 17:
          ...
          return [
            ...
            uploadScreenshot(
              buffer,
              "".concat(runId, "/").concat(pageId, "/callnow_plugin.png"),
            ),
          ]
        case 18:
          ...
          return [
            ...
            adminPage
              .goto(
                "".concat(
                  baseUrl,
                  "/wp-admin/options-general.php?page=call-now-button",
                ),
                {
                  waitUntil: "networkidle",
                  timeout: 30000,
        ...
        case 24:
          ...
          return [
            ...
            uploadScreenshot(
              settingsBuffer,
              "".concat(runId, "/").concat(pageId, "/callnow_settings.png"),
            ),
          ]
        case 25:
        ...
        case 32:
          ...
          return [
            ...
            uploadScreenshot(
              mobileBuffer,
              "".concat(runId, "/").concat(pageId, "/callnow_mobile.png"),
            ),
          ]
        case 33:
            ...
            [
              {
                ...
                description:
                  "Please verify the Call Now plugin setup and homepage links using the evidence screenshots.",
                screenshot_url: screenshotUrls,
                status: "open",
                ai_generated: false,
              },
