...
async function main() {
  ...
  const url = "https://3.basecampapi.com/4023059/buckets/42822223/todolists/9899445368/todos.json?page=2"
  const response = await axios.get(url, { headers })
  console.log("Page 2 todos count:", response.data.length)
  console.log("Page 2 checklist items:")
